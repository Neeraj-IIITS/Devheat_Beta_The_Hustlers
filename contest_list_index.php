...
<header class="text-gray-600 body-font" style="user-select: auto; background-color: rgb(198, 204, 207);">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center" style="user-select: auto;">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center" style="user-select: auto;">
          ...
          <a href="contest_record_index.php" class="mr-5 hover:text-gray-900" style="user-select: auto;">Contests</a>
    ...
    <div class="container">
        ...
        ?>
        <a href="contest_list_add.php" class="btn btn-dark mb-3">Add New</a>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="contest_list_edit.php?id=<?php echo $row ['id'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                            <a href="contest_list_delete.php?id=<?php echo $row ['id'] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
