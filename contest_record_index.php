...
<header class="text-gray-600 body-font" style="user-select: auto; background-color: rgb(198, 204, 207);">
    ...
    <div class="container">
        ...
        ?><br>
        <a href="contest_record_add.php" class="btn btn-dark mb-3">Add New</a>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="contest_record_edit.php?id=<?php echo $row ['id'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                            <a href="contest_record_delete.php?id=<?php echo $row ['id'] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
